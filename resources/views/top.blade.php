...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/message.js'])
    </head>
    <body>
                ...
                <div class="text-gray-700 body-font">
                    ...
                    <div class="container mx-auto flex px-5 py-8 md:py-4 md:flex-row flex-col items-center">
                        <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">せっかく買うなら、お墨付きを。
                            </h1>
                            <p class="mb-8 leading-relaxed">コンビニマスターは、<span class="font-bold text-pink-500">自炊派のため</span>のコンビニ商品投稿サービス。<br>本当におすすめのコンビニ商品を投稿しあって、後悔のない買い物をしよう。</p>
                        </div>
