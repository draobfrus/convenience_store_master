            ...
            <div class="mt-4">
                <div class="bg-white mx-auto w-full md:w-2/3 rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500">
                    ...
                    <div class="w-full">
                        ...
                        @if($post->store)
                            <span class="font-bold bg-cyan-600 text-white text-sm mr-2 my-2 px-3 py-1 rounded-full">{{ $post->store->storename }}</span>
                        @endif
                        <div class="rounded-lg bg-white group my-2 block overflow-hidden">
                            @if($post->image)
